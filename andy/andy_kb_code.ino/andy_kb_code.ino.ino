...
void updateDisplay() {
    ...
    if ( game & player2_1st ) { lc.setDigit( 0,1,1,0 ); }
    if ( game & player2_2nd ) { lc.setDigit( 0,1,2,0 ); }
    if ( game & player2_3rd ) { lc.setDigit( 0,1,3,0 ); }

    if ( game & player3_1st ) { lc.setDigit( 0,2,1,0 ); }
    if ( game & player3_2nd ) { lc.setDigit( 0,2,2,0 ); }
    if ( game & player3_3rd ) { lc.setDigit( 0,2,3,0 ); }
